...
function About() {
  return (
    <div>
      ...
      <p>
        As I transition from the world of sports to the dynamic landscape of technology, I'm excited about the
        opportunities and challenges that lie ahead. The same passion that fueled my athletic achievements now fuels
        my desire to build elegant, functional, and impactful software solutions.
      </p>
      <p>
        Thank you for joining me on this incredible journey. Feel free to explore my portfolio to witness the fusion
        of my sporting spirit and technological aspirations.
      </p>
